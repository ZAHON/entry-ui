...
By default, the `Alert.Root` component renders an `<div>` element. For a complete overview of the default elements, refer to the [Rendered elements](#rendered-elements) section.
