...
| :----------- | :------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `state`      | `Readonly<Signal<T>>`     | A readonly signal representing the current state. Provides the value from the `controlledSignal` in controlled mode, or the internal signal in uncontrolled mode.                                         |
