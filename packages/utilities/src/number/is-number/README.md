...
| :-------- | :-------- | :------ | :------------------------------------------------------------------------------------------------------- |
| `value*`  | `unknown` | `—`     | The input value to evaluate. Accepts any type and safely identifies whether it is a valid numeric value. |
...
| Type              | Description                                                                                                                |
| :---------------- | :------------------------------------------------------------------------------------------------------------------------- |
| `value is number` | Returns `true` if the value is a primitive `number` and is not `NaN`. Returns `false` for `NaN` and all non-numeric types. |
